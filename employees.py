...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.frame.setGeometry(QRect(10, 10, 891, 381))
...
"border: none;")
        ...
        self.layoutWidget.setGeometry(QRect(10, 40, 871, 331))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QCoreApplication.translate("Dialog", u"Employees", None))
        self.btn_add.setText(QCoreApplication.translate("Dialog", u"Add employer", None))
