...
################################################################################
## Form generated from reading UI file 'add_fac_det.ui'
##
...
"about prices", None))
        ...
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("Dialog", u"id_factory", None))
        self.lineEdit_4.setText("")
        self.lineEdit_4.setPlaceholderText(QCoreApplication.translate("Dialog", u"id_detail", None))
        self.lineEdit_5.setText("")
        self.lineEdit_5.setPlaceholderText(QCoreApplication.translate("Dialog", u"price", None))
