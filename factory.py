...
################################################################################
## Form generated from reading UI file 'factory.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QRect(290, 10, 131, 21))
...
"border: none;")
        ...
        self.layoutWidget.setGeometry(QRect(8, 42, 631, 321))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QCoreApplication.translate("Dialog", u"Factories", None))
        self.btn_add.setText(QCoreApplication.translate("Dialog", u"Add factory", None))
        self.btn_delete.setText(QCoreApplication.translate("Dialog", u"Delete current", None))
    # retranslateUi
