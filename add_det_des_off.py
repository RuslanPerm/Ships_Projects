...
################################################################################
## Form generated from reading UI file 'add_det_des_off.ui'
##
...
"details", None))
        ...
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("Dialog", u"id_detail", None))
        self.lineEdit_4.setText("")
        self.lineEdit_4.setPlaceholderText(QCoreApplication.translate("Dialog", u"id_des_office", None))
        self.lineEdit_2.setText("")
        self.lineEdit_2.setPlaceholderText(QCoreApplication.translate("Dialog", u"quantity", None))
