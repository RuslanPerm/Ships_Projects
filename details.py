...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QCoreApplication.translate("Dialog", u"Details", None))
        self.btn_add.setText(QCoreApplication.translate("Dialog", u"Add detail", None))
