...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.frame.setGeometry(QRect(10, 0, 861, 381))
        ...
        self.label.setGeometry(QRect(370, 10, 131, 21))
...
"border: none;")
        ...
        self.layoutWidget.setGeometry(QRect(10, 40, 841, 331))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QCoreApplication.translate("Dialog", u"Projects", None))
        self.btn_add.setText(QCoreApplication.translate("Dialog", u"Add project", None))
